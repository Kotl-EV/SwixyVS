...
internal static class IslandHubIcons
{
    ...
    {
        var houseW = size * 0.62;
        var houseH = size * 0.38;
        var houseX = x + (size - houseW) / 2;
        var houseY = y + size * 0.42;

        DrawGlow(ctx, x + size * 0.5, houseY + houseH * 0.35, size * 0.34, 1, 0.72, 0.22);

        ctx.NewPath();
        ctx.MoveTo(houseX, houseY + houseH * 0.42);
        ctx.LineTo(houseX + houseW * 0.5, houseY);
        ctx.LineTo(houseX + houseW, houseY + houseH * 0.42);
        ctx.ClosePath();
        ctx.SetSourceRGBA(0.78, 0.28, 0.2, 0.96);
        ctx.FillPreserve();
        ctx.SetSourceRGBA(0.28, 0.08, 0.06, 0.8);
        ctx.LineWidth = Math.Max(1, size * 0.03);
        ctx.Stroke();

        DrawRoundedRect(ctx, houseX + houseW * 0.12, houseY + houseH * 0.4, houseW * 0.76, houseH * 0.58, size * 0.03);
        ctx.SetSourceRGBA(0.86, 0.74, 0.48, 0.98);
        ctx.FillPreserve();
        ctx.SetSourceRGBA(0.28, 0.18, 0.08, 0.75);
        ctx.LineWidth = Math.Max(1, size * 0.03);
        ctx.Stroke();

        DrawRoundedRect(ctx, houseX + houseW * 0.38, houseY + houseH * 0.58, houseW * 0.24, houseH * 0.4, size * 0.02);
        ctx.SetSourceRGBA(0.34, 0.2, 0.1, 0.95);
        ctx.Fill();

        DrawRoundedRect(ctx, houseX + houseW * 0.16, houseY + houseH * 0.52, houseW * 0.18, houseH * 0.18, size * 0.02);
        ctx.SetSourceRGBA(0.55, 0.82, 0.95, 0.85);
        ctx.FillPreserve();
        ctx.SetSourceRGBA(0.15, 0.22, 0.28, 0.7);
        ctx.LineWidth = Math.Max(1, size * 0.025);
        ctx.Stroke();

        ctx.SetSourceRGBA(0.92, 0.92, 0.92, 0.55);
        ctx.Arc(houseX + houseW * 0.72, houseY + houseH * 0.18, size * 0.035, 0, Math.PI * 2);
        ctx.Fill();
    }
