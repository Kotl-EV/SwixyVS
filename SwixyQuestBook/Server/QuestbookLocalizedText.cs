...
{
    /// <summary>
    /// Multi-language text stored in quests.json.
    /// JSON may be a plain string (legacy / single language) or an object map: { "en": "...", "ru": "..." }.
    /// </summary>
    ...
    public sealed class QuestbookLocalizedText
    {
        ...
        /// <summary>
        /// Prefer requested language, then en, then any non-empty entry.
        /// </summary>
        ...
        public QuestbookLocalizedText Clone()
        {
            return new QuestbookLocalizedText(entries);
        }
    ...
    public sealed class QuestbookLocalizedTextJsonConverter : JsonConverter<QuestbookLocalizedText>
    {
            ...
            JsonSerializerOptions options)
        {
            ...
            // Always write as a map so multi-language is explicit in quests.json.
