...
/// <summary>
/// Shared runtime state loaded on both sides in StartPre.
/// Not a ModSystem — Server and Client mods call <see cref="Load"/> independently.
/// </summary>
public static class SkyBlockRuntime
{
